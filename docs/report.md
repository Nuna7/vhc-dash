...
The primary data structure stored in the ranker database is the `PRC` (Paraphrase Rank Candidate) object, which is composed of an input, an array of `Paraphrase` objects, and an `RCV` (Ranked Choice Voting sytem) object.
